...
import type { InternalListOptionsResponse, InternalUserSummaryResponse } from '../adminApi'
...
export function createUserColumns(options: InternalListOptionsResponse | null): Array<RsqlColumn<InternalUserSummaryResponse>> {
  const emailVerifiedOptions = getFieldValues(options, 'emailVerified', ['true', 'false'])
  const phoneVerifiedOptions = getFieldValues(options, 'phoneVerified', ['true', 'false'])
